...
export const MAIN_MENU: MenuItem[] = [
  ...
  },
  {
    ...
    //   {
    //     id: "consulting",
    //     title: "Tư vấn khám chữa bệnh từ xa",
    //     path: "/consulting",
    //     icon: MessageCircleHeart,
    //   },
    // ],
...
export const MOCK_NEWS: NewsItem[] = [
  {
    id: 1,
    title:
      "Sở Y tế Hà Nội: Triển khai kế hoạch đảm bảo y tế phục vụ Tết Nguyên đán 2026",
    excerpt:
      "Giám đốc Sở Y tế yêu cầu các cơ sở khám chữa bệnh trực 24/24, chuẩn bị đầy đủ cơ số thuốc và phương án cấp cứu ngoại viện để phục vụ nhân dân đón Tết Bính Ngọ 2026...",
    date: "10/01/2026",
  ...
  },
  {
    id: 2,
    title:
      "Tổng kết công tác Y tế năm 2025: Hà Nội hoàn thành 100% chỉ tiêu chuyển đổi số",
    excerpt:
      "Tại hội nghị tổng kết năm 2025, ngành Y tế Thủ đô được đánh giá cao nhờ việc đồng bộ hóa dữ liệu sức khỏe toàn dân và triển khai bệnh án điện tử tại tất cả các tuyến...",
    date: "05/01/2026",
  ...
  },
  {
    id: 3,
    title:
      "Cảnh báo gia tăng các bệnh đường hô hấp trong đợt rét đậm đầu năm 2026",
    excerpt:
      "CDC Hà Nội ghi nhận số ca mắc cúm A và viêm phổi tăng nhẹ tại các quận huyện ngoại thành do thời tiết chuyển lạnh sâu. Người dân cần chủ động giữ ấm và tiêm phòng...",
    date: "08/01/2026",
  ...
  },
  {
    id: 4,
    title:
      "Bệnh viện Xanh Pôn phẫu thuật thành công ca ghép tạng thứ 100 trong năm 2025",
    excerpt:
      "Đánh dấu cột mốc quan trọng trong phát triển kỹ thuật cao, kíp mổ đã thực hiện thành công ca ghép thận từ người cho sống, bệnh nhân hồi phục tốt sau 1 tuần...",
    date: "28/12/2025",
...
export const MOCK_CULTURE = [
  ...
  },
  {
    id: "c2",
    title:
      'Triển lãm ảnh "Thầy thuốc Hà Nội làm theo lời Bác" tại Phố đi bộ Hồ Gươm',
    date: "05/01/2026",
