...
const sosIcon = L.divIcon({
  ...
  html: `<div class="relative w-12 h-12 flex items-center justify-center">
            ...
            <div class="relative bg-red-600 w-10 h-10 rounded-full border-2 border-white flex items-center justify-center text-white shadow-xl">SOS</div>
         </div>`,
  iconSize: [48, 48],
  iconAnchor: [24, 24],
});
...
const EmergencyCenter = () => {
  const [ambulances, setAmbulances] = useState<AmbulanceUnit[]>(generateAmbulances());
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-3 flex justify-between items-center shadow-sm z-20">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold uppercase text-gray-800 tracking-tight">Cấp cứu 115 Hà Nội</h1>
        ...
        <div className="flex items-center gap-4">
           <div className="hidden lg:flex bg-gray-50 px-4 py-2 rounded-lg border border-gray-200 gap-4 text-xs font-bold">
              <div className="flex items-center gap-2">
                 ...
                 <span className="text-gray-700">{ambulances.filter(a => a.status === 'AVAILABLE').length} Rảnh</span>
              </div>
              <div className="flex items-center gap-2">
