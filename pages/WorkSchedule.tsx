...
const mockScheduleData: WorkScheduleType[] = [
  ...
  },
  {
    ...
    start_time: "2026-01-29T09:00:00.000Z", // 16:00 VN
    end_time: "2026-01-29T10:30:00.000Z",
  ...
  },
  {
    ...
    start_time: "2026-01-30T01:00:00.000Z", // 08:00 VN
    end_time: "2026-01-30T02:30:00.000Z",
  ...
  },
  {
    ...
    start_time: "2026-01-30T01:30:00.000Z", // 08:30 VN
    end_time: "2026-01-30T03:00:00.000Z",
  ...
  },
  {
    ...
    start_time: "2026-01-30T01:30:00.000Z",
    end_time: "2026-01-30T03:00:00.000Z",
  ...
  },
  {
    ...
    start_time: "2026-01-30T06:30:00.000Z", // 13:30 VN
    end_time: "2026-01-30T08:00:00.000Z",
  ...
  },
  {
    ...
    start_time: "2026-01-31T02:00:00.000Z", // 09:00 VN
    end_time: "2026-01-31T03:30:00.000Z",
    location: "Hội trường SYT",
    presider_id: 1,
    coordinating_unit: "Sở Y tế Hà Nội",
    priority: "LOW",
  ...
  },
  {
    ...
    start_time: "2026-01-29T02:00:00.000Z",
    end_time: "2026-01-29T03:30:00.000Z",
  ...
  },
  {
    ...
    start_time: "2026-01-29T01:00:00.000Z", // 08:00 VN
    end_time: "2026-01-29T02:30:00.000Z",
  ...
  },
  {
    ...
    start_time: "2026-01-31T00:00:00.000Z", // 07:00 VN
    end_time: "2026-01-31T01:30:00.000Z",
  ...
  },
  {
    ...
    start_time: "2026-01-29T06:30:00.000Z", // 13:30 VN
    end_time: "2026-01-29T08:00:00.000Z",
  ...
  },
  {
    ...
    start_time: "2026-01-29T07:00:00.000Z", // 14:00 VN
    end_time: "2026-01-29T08:30:00.000Z",
    ...
    if (mockScheduleData.length > 0) {
      ...
      const grouped = mockScheduleData.reduce(
        (acc: { [key: string]: GroupedSchedule }, current) => {
          ...
          if (isBefore(normalizedItemDate, normalizedToday)) {
            return acc;
          }
          const formattedDate = format(itemDate, "EEEE, 'ngày' dd/MM/yyyy", {
            locale: vi,
          });
          const isCurrentDay = isSameDay(normalizedItemDate, normalizedToday); // Calculate isCurrentDay
          if (!acc[dateKey]) {
            acc[dateKey] = {
              dateKey: dateKey,
            ...
            {groupedSchedules.find((day) => day.isToday) &&
              selectedDateKey !==
                ...
                <Button
                  ...
                  icon="pi pi-calendar"
                  iconPos="left"
                  className="w-full text-left px-4 py-2 mb-3 rounded-lg bg-blue-50 text-blue-700 font-bold hover:bg-blue-100"
                  text
                />
              )}
            <ul>
              {groupedSchedules
                ...
                .map((day) => (
                  <li key={day.dateKey} className="my-2">
                    <Button
