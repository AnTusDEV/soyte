    ...
    <div className="bg-slate-50 min-h-screen font-sans">
      ...
      <div className="bg-white border-b border-gray-200 px-4 py-2 flex flex-col lg:flex-row justify-between items-center shadow-sm">
        <div className="flex items-center gap-3 mb-2 lg:mb-0">
          ...
          <div>
            <h1 className="text-lg font-bold text-blue-900 leading-none">
              HSSK
            </h1>
            <p className="text-xs text-gray-500 font-medium">
              Hồ sơ sức khỏe Hà Nội
            </p>
          </div>
        </div>
      ...
      <div className="p-4 md:p-6 max-w-[1600px] mx-auto">
            ...
            <div className="lg:col-span-1 flex gap-2">
              <div className="flex-grow">
                <label className="block text-xs font-semibold text-red-500 mb-1">
                  Tính đến ngày <span className="text-red-500">*</span>
                </label>
                <input
                  type="date"
                  className="w-full bg-white border border-gray-300 text-gray-700 text-sm rounded px-2 py-2 focus:outline-none"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 mb-8">
          ...
          <div className="bg-[#0078d4] rounded-md p-4 text-white shadow-md relative min-h-[100px] hover:shadow-lg transition-shadow cursor-pointer">
            ...
            <p className="text-xs font-medium opacity-90">
              Lượt liên thông <br /> dữ liệu KCB
            </p>
          ...
          <div className="bg-[#008075] rounded-md p-4 text-white shadow-md relative min-h-[100px] hover:shadow-lg transition-shadow cursor-pointer">
            ...
            <p className="text-xs font-medium opacity-90">
              Lượt liên thông <br /> dữ liệu tiêm chủng
            </p>
            <div className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/20 p-2 rounded-full">
          ...
          <div className="bg-[#4f6bed] rounded-md p-4 text-white shadow-md relative min-h-[100px] hover:shadow-lg transition-shadow cursor-pointer">
            ...
            <p className="text-xs font-medium opacity-90">
              Lượt liên thông <br /> ngày hôm trước
            </p>
            <div className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/20 p-2 rounded-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-white rounded-md p-5 shadow-sm border border-gray-100 flex items-center justify-between min-h-[120px]">
            <div>
              ...
              <p className="text-[10px] text-gray-400 font-medium">
                Chiếm <span className="font-bold text-gray-600">20.5%</span>
              </p>
            </div>
          ...
          <div className="bg-white rounded-md p-5 shadow-sm border border-gray-100 flex items-center justify-between min-h-[120px]">
            <div>
              ...
              <p className="text-[10px] text-gray-400 font-medium">
                Chiếm <span className="font-bold text-gray-600">30.8%</span>
              </p>
            </div>
            <div className="bg-[#0078d4] p-3 rounded-full text-white shadow-sm">
              <User size={24} />
          ...
          <div className="bg-white rounded-md p-5 shadow-sm border border-gray-100 flex items-center justify-between min-h-[120px]">
            <div>
              ...
              <p className="text-[10px] text-gray-400 font-medium">
                Chiếm <span className="font-bold text-gray-600">17.9%</span>
              </p>
            </div>
        ...
        <h3 className="text-sm font-bold text-gray-800 mb-3 uppercase mt-3">
          Thống kê
        </h3>
        <div id="view-design" style={{ height: "400px" }} className="bg-white rounded-md shadow-sm border border-gray-200 p-4">
            {/* Placeholder for the detailed view/design component */}
        </div>
        {/* Footer of Dashboard (Visual Separation) */}
        <div className="mt-8 pt-4 border-t border-gray-200">
          <h3 className="text-sm font-bold text-gray-600 mb-4">
            Tiến độ chuẩn hóa theo hộ gia đình
          </h3>
