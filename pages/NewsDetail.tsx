  ...
  >
    <div className="w-24 h-20 rounded-md overflow-hidden flex-shrink-0">
      <img
        src={
          post.image ||
          "https://images.unsplash.com/photo-1583088580009-2d947c3e90a6?q=80&w=400&auto=format&fit=crop"
        }
        alt={post.title}
                ...
                <div className="flex flex-wrap items-center justify-between gap-4 py-3 border-y border-gray-100 my-6">
                  <div className="flex items-center gap-2 sm:gap-4">
                    <button
                      ...
                      className="flex items-center gap-1.5 text-xs font-bold text-gray-600 hover:text-red-600 transition-colors"
                    >
