        ...
        <div className="container mx-auto px-4 z-10 relative grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="flex space-x-4 pt-4">
              ...
              <Link
                to="/news/events"
                className="border border-white text-white px-6 py-3 rounded font-bold hover:bg-white/10 transition"
              >
                Tin tức mới nhất
              </Link>
            </div>
            ...
            {SERVICE_CATEGORIES.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <h4
                    className={`font-bold mb-1 text-base md:text-lg leading-tight relative z-10 ${item.titleClass}`}
                  >
                    {item.title}
                  </h4>
                </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 divide-y md:divide-y-0 md:divide-x divide-gray-100">
            <div className="pt-6 md:pt-0">
              ...
              <div className="group mb-4 cursor-pointer">
                ...
                <h4 className="font-bold text-gray-800 leading-snug group-hover:text-pink-600">
                  {MOCK_CULTURE[0].title}
                </h4>
              </div>
              {/* List */}
              <ul className="space-y-3">
                {MOCK_CULTURE.slice(1).map((item) => (
                  <li
                    key={item.id}
                    className="text-sm text-gray-600 border-t border-gray-100 pt-2 hover:text-pink-600 cursor-pointer line-clamp-2"
                  >
                    • {item.title}
                  </li>
                ))}
            ...
            <div className="pt-6 md:pt-0 md:pl-8">
              ...
              <div className="group mb-4 cursor-pointer">
                ...
                <h4 className="font-bold text-gray-800 leading-snug group-hover:text-orange-600">
                  {MOCK_SPORTS[0].title}
                </h4>
              </div>
              <ul className="space-y-3">
                {MOCK_SPORTS.slice(1).map((item) => (
                  <li
                    key={item.id}
                    className="text-sm text-gray-600 border-t border-gray-100 pt-2 hover:text-orange-600 cursor-pointer line-clamp-2"
                  >
                    • {item.title}
                  </li>
                ))}
            ...
            <div className="pt-6 md:pt-0 md:pl-8">
              ...
              <div className="group mb-4 cursor-pointer">
                ...
                <h4 className="font-bold text-gray-800 leading-snug group-hover:text-blue-600">
                  {MOCK_INTERNATIONAL[0].title}
                </h4>
              </div>
              <ul className="space-y-3">
                {MOCK_INTERNATIONAL.slice(1).map((item) => (
                  <li
                    key={item.id}
                    className="text-sm text-gray-600 border-t border-gray-100 pt-2 hover:text-blue-600 cursor-pointer line-clamp-2"
                  >
                    • {item.title}
                  </li>
                ))}
