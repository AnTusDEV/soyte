...
import { Menu, X, Search, Phone, ChevronDown, LogOut, User, PlusCircle, Send } from 'lucide-react';
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-white w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
            ...
            <div className="p-6 space-y-4">
              <div>
                <label className="block text-xs font-bold text-gray-500 uppercase mb-1">Tiêu đề bài viết</label>
                <input type="text" placeholder="Nhập tiêu đề tin tức..." className="w-full p-3 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary-100 outline-none font-medium" />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-gray-500 uppercase mb-1">Chuyên mục</label>
                ...
                <div>
                  <label className="block text-xs font-bold text-gray-500 uppercase mb-1">Hình ảnh đại diện</label>
                  <input type="file" className="w-full text-xs text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-xs file:font-semibold file:bg-primary-50 file:text-primary-700 hover:file:bg-primary-100" />
                </div>
              </div>
              <div>
                <label className="block text-xs font-bold text-gray-500 uppercase mb-1">Nội dung tóm tắt</label>
                <textarea rows={2} placeholder="Mô tả ngắn gọn về tin tức..." className="w-full p-3 bg-gray-50 border border-gray-200 rounded-lg outline-none"></textarea>
              </div>
              <div>
                <label className="block text-xs font-bold text-gray-500 uppercase mb-1">Nội dung chi tiết</label>
                <textarea rows={6} placeholder="Nội dung đầy đủ của bài viết..." className="w-full p-3 bg-gray-50 border border-gray-200 rounded-lg outline-none"></textarea>
              </div>
